...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" <<-EOSQL
    ...
    CREATE DATABASE red_social_login OWNER admin;
    GRANT ALL PRIVILEGES ON DATABASE red_social_login TO admin;

      CREATE DATABASE red_social_personas OWNER admin;
        GRANT ALL PRIVILEGES ON DATABASE red_social_personas TO admin;
